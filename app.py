...
lettre_codee = [
    ...
    ("Puis nous traçions nos premiers projets. Ceux de nous voir en Janvier ____ et finir avec les restaurants de Ouagadougou😂.", ["2024"]),
    ...
    ("Je dois t'avouer que je n'étais pas si ____ de te rencontrer. Mais j'aimais bien ce que tu dégageais.", ["impatient"]),
    ...
    ("Quand je suis rentré ! Ahhh Quand je suis rentré ! ____ 2024, je te dis ! Incroyablissement incroyable !", ["Janvier"]),
    ...
    ("Je vais te ____ dire.", ["le"]),
    ("Je voyais la reine qu’il me fallait, celle qui m’aidait à conquérir mon royaume et qui, comme un précieux ____, scellait ma victoire en posant cette couronne sur ma tête. 👑💖💊", ["Remède"]),
    ...
    ("Je n'avais plus qu'une seule ____.", ["Mission"]),
    ("Celle de te marquer de mon empreinte. Celle graver ma signature en toi, tel un artisan signant son ____.", ["Oeuvre"]),
    ("Car oui, tu es cette oeuvre qu'on ne pourrait même pas vendre aux ____. Cette oeuvre que tout le monde veut s'arracher. Cette oeuvre qui élève l'artiste.", ["Enchères"]),
    ("Quel ne fut mon désaroi de te savoir sur le départ, de 'Me' savoir sur le départ pour la ____.", ["France"]),
    ("Ecoute ____ mots : ", ["Ces"]),
